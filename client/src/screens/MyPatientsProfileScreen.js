...
function MyPatientsProfileScreen({ navigation, route }) {
    ...
    return (
        <ScrollView>
            <Screen >
                <TextInput style={styles.title}> PACIENTO PROFILIS </TextInput>

                {
                    <View style={styles.userInfoSection}>
                        ...
                        <View style={styles.row}>
                            <Icons name="kickstarter-k" color="#6c88c4" size={45} />
...
export default MyPatientsProfileScreen;